...
/***/ function(module, exports, __webpack_require__) {
	...
	var containers_1 = __webpack_require__(355);
	var services_1 = __webpack_require__(28);
	var forms_2 = __webpack_require__(21);
	var control_messages_component_1 = __webpack_require__(362);
	var validation_service_1 = __webpack_require__(361);
	var next_trip_button_1 = __webpack_require__(363);
	// import { AppModal }   from './app/ui/note-creator/modal.component';
	var ui_1 = __webpack_require__(364);
	    ...
	    AppModule = __decorate([
	        core_1.NgModule({
	            declarations: [
	                ...
	                next_trip_button_1.NextTrip
	            ],
	            providers: [validation_service_1.ValidationService, services_1.NoteService, services_1.ApiService],
	            imports: [
	                http_1.HttpModule,
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	     true ? factory(exports, __webpack_require__(1), __webpack_require__(22), __webpack_require__(4), __webpack_require__(5), __webpack_require__(23)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var services = __webpack_require__(28);
	var app_1 = __webpack_require__(352);
	exports.App = app_1.App;
	var routes_1 = __webpack_require__(353);
	exports.routes = routes_1.routes;
	var mapValuesToArray = function (obj) { return Object.keys(obj)
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var api_1 = __webpack_require__(29);
	exports.ApiService = api_1.ApiService;
	var notes_1 = __webpack_require__(351);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var main_1 = __webpack_require__(356);
	exports.Main = main_1.Main;
	var notes_1 = __webpack_require__(357);
	exports.Notes = notes_1.Notes;
	var addtrip_1 = __webpack_require__(358);
	exports.AddTrip = addtrip_1.AddTrip;
	var trips_1 = __webpack_require__(359);
	exports.Trips = trips_1.Trips;
	var login_1 = __webpack_require__(360);
	...
	var Notes = (function () {
	    ...
	    Notes = __decorate([
	        core_1.Component({
	            ...
	            providers: [_1.NoteService, _1.ApiService],
	            styleUrls: ["app/containers/notes/notes.css"],
	            templateUrl: 'app/containers/notes/notes.html'
	        }), 
	        __metadata('design:paramtypes', [(typeof (_a = typeof _1.NoteService !== 'undefined' && _1.NoteService) === 'function' && _a) || Object])
	    ], Notes);
	    return Notes;
	    var _a;
	}());
	...
	var AddTrip = (function () {
	    ...
	    AddTrip = __decorate([
	        core_1.Component({
	            ...
	            templateUrl: 'app/containers/addtrip.html'
	        }), 
	        __metadata('design:paramtypes', [])
	    ], AddTrip);
	    return AddTrip;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Trips = (function () {
	    ...
	    Trips.prototype.saveUser = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var validation_service_1 = __webpack_require__(361);
	var Login = (function () {
	    function Login(formBuilder) {
	        this.formBuilder = formBuilder;
	        this.userForm = this.formBuilder.group({
	            'name': ['', [forms_1.Validators.required, forms_1.Validators.minLength(1)]],
	            'email': ['', [forms_1.Validators.required, validation_service_1.ValidationService.emailValidator]],
	            'password': ['', [forms_1.Validators.required, forms_1.Validators.minLength(5), validation_service_1.ValidationService.passwordValidator]]
	        });
	        console.log(this.userForm);
	    }
	    Login.prototype.saveUser = function () {
	        if (this.userForm.dirty && this.userForm.valid) {
	...
	var ControlMessagesComponent = (function () {
	    ...
	    ControlMessagesComponent = __decorate([
	        core_1.Component({
	            ...
	            template: "<div [className] = \"'error'\" *ngIf=\"errorMessage !== null\"   >{{errorMessage}}</div>"
	        }), 
	        __metadata('design:paramtypes', [])
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var router_1 = __webpack_require__(354);
	var NextTrip = (function () {
	    function NextTrip(router) {
	        this.router = router;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var app_bar_1 = __webpack_require__(365);
	exports.AppBar = app_bar_1.AppBar;
	var note_card_1 = __webpack_require__(366);
	exports.NoteCard = note_card_1.NoteCard;
	var note_creator_1 = __webpack_require__(367);
	exports.NoteCreator = note_creator_1.NoteCreator;
	var color_picker_1 = __webpack_require__(368);
	exports.ColorPicker = color_picker_1.ColorPicker;
	// export { AppModal } from './note-creator/modal.component'; 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteCreator = (function () {
	    function NoteCreator() {
	        ...
	        this.colors = ['#B19CD9', '#FF6961', '#77DD77', '#AEC6CF'];
	        //Data of all images
	        // private hex1= {
	        //   photo: '1.png'
	        // };
